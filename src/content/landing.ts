...
export const landing: Landing = {
  hero: {
    ...
    headline: 'Schluss mit dem Theater.\nBauen wir Organisationen, die liefern.',
    lead: 'Ich bin Ralph. Ich entwickle Menschen und designe Organisationen – pragmatisch, ohne Bullshit, ohne Beraterfolien zum Selbstzweck. Punk als Haltung, Handwerk als Beweis.',
  },
  ...
  sections: [
    {
      ...
      body: 'Angefangen habe ich da, wo es konkret wird: im Code. Aus 14 Jahren Softwareentwicklung und -architektur wurden 10 Jahre Führung. Irgendwann war klar, dass die teuersten Bugs nicht in der Software stecken, sondern in der Organisation drumherum – in Strukturen, die gegen die eigenen Leute arbeiten. Genau da setze ich an: Ich baue Organisationen wie Systeme. Beobachten, verstehen, umbauen, messen.',
    },
    {
      id: 'haltung',
      kicker: 'Die Haltung',
      title: 'Kein Bullshit. Kein Upselling. Keine heilige Methode.',
      body: 'Ich verkaufe keine Methode von der Stange. Ich schaue zuerst, was bei Ihnen wirklich klemmt, und baue dann gemeinsam mit Ihnen die Lösung – egal, ob am Ende ein bekanntes Verfahren wie Scrum oder Design Thinking draufsteht oder schlicht gesunder Menschenverstand. Die gängigen Methoden kenne ich aus der Praxis; ich bete sie nur nicht an.',
    },
    {
      id: 'erfahrung',
      kicker: 'Der Beweis',
      ...
      cards: [
        {
          period: '2025 – heute · Thomann',
          title: 'Den Online-Shop fit für die Zukunft machen',
          body: 'Ich leite den Umbau einer in die Jahre gekommenen Shop-Plattform (rund 1,5 Mrd. € Umsatz) auf eine moderne, wartbare Technik. Dafür bringe ich ein großes Team aus Entwicklung, Infrastruktur, Architektur und Design an einen Tisch – über Abteilungsgrenzen hinweg, ohne klassische Vorgesetztenrolle.',
        },
        {
          period: '2019 – 2025 · Thomann',
          title: 'Eine Abteilung von 25 auf 100 Menschen aufgebaut',
          body: 'Ich habe die Technik- und Datenabteilung vervierfacht – und dafür gesorgt, dass sie nicht im Chaos versinkt: klare Zuständigkeiten, faire Karriere- und Gehaltswege, eine Kultur, in der Leute gern bleiben, explizite Prozesse. Mit Verantwortung für ein Jahresbudget von rund 1,2 Mio. €.',
        },
        {
          period: '2018 – 2019 · CodeCamp:N/Nürnberger Versicherung',
        ...
        {
          period: '2014 – 2018 · verschiedene Startups, z.B. Rakete 7, Favendo',
